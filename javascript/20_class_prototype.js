...
class Person{
 ...
 console.log(typeof(Person)) //class function으로 출력
...
console.log(myMultiplication.ret)

// [3] : 어떻게 클래스가 타입체크에서 function으로 찍히는지?
...
//   해당 클래스의 인스턴스(객체)가 생성되면 추가된 메서드를 자유롭게 이용할수있음.
